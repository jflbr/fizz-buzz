...
FIZZBUZZ_REQUEST_SCHEMA = {
    ...
    "limit": {"type": "integer", "required": True, "min": 1, "max": MAX_LIMIT},
    "str1": {"type": "string", "required": True, "minlength": 1, "maxlength": 16},
    "str2": {"type": "string", "required": True, "minlength": 1, "maxlength": 16},
}
